...
var _user$project$Main$initPlayer = F2(
	function (pseudo, team) {
		var url = 'http://localhost:8080/Joueur1/Blanc/';
		return A2(
										...
										},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(model.move.startLine + 1),
														A2(
															_elm_lang$core$Basics_ops['++'],
															',',
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(model.move.startRow + 1),
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	' || ',
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString(model.move.endLine + 1),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			',',
																			_elm_lang$core$Basics$toString(model.move.endRow + 1))))))))),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
