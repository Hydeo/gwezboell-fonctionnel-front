...
var _user$project$Main$init = function (topic) {
	return {
		ctor: '_Tuple2',
		_0: A4(_user$project$Main$Model, topic, 'waiting.gif', 'lol', _user$project$Main$generatePlate),
		...
		switch (_p3.ctor) {
			...
			case 'NewGif':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A4(_user$project$Main$Model, model.topic, _p3._0._0, model.partyStatus, model.plate),
			...
			default:
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A4(_user$project$Main$Model, model.topic, model.gifUrl, _p3._0._0, model.plate),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
